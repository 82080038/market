...
5. If a new numbered doc is warranted (e.g., filling a major gap not covered by 01-102), add it and update the index in `00-README.md`. Number new docs sequentially starting from 103 unless there is a strong reason to insert within the 00-102 range.
...
10. **Pustaka count (AGENTS.md §1):** 103 docs (00-README + 01-102). New docs start from 103.
