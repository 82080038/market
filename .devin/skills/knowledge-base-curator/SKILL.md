...
5. If a new numbered doc is warranted (e.g., filling a major gap not covered by 01-100), add it and update the index in `00-README.md`. Number new docs sequentially starting from 101 unless there is a strong reason to insert within the 00-100 range.
...
10. **Pustaka count (AGENTS.md §1):** 101 docs (00-README + 01-100). New docs start from 101.
