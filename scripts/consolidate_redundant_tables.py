...
Usage:
  DB_PATH=data/market_research.db uv run python scripts/consolidate_redundant_tables.py
  DB_PATH=data/market_research.db uv run python scripts/consolidate_redundant_tables.py --dry-run
"""
